...
export const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      {
        path: 'add-task/:projectId', component: TaskFormComponent
      
      },
      {
        path: 'add-task/:projectId/:taskId', component: TaskFormComponent
      },
      { path: 'add-task/:projectId/:projectName', component: TaskFormComponent },

// For editing task
{ path: 'add-task/:projectId/:projectName/:taskId', component: TaskFormComponent },
{ path: 'add-task/:projectId/:projectName', component: TaskFormComponent },
